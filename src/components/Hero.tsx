...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-[#f5f1ea]"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full pt-25 pb-16 lg:pt-25 lg:pb-24">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="relative z-10">
            ...
            >
              Crafting scalable digital systems and elegant web experiences
              for modern businesses — from concept to production.
            </motion.p>

            <motion.div {...anim(0.38)} className="flex flex-col sm:flex-row gap-4">
              <motion.a
                href="#projects"
          ...
          >
            <div className="relative w-full max-w-lg aspect-square">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img
                  ...
                  style={{ filter: 'drop-shadow(0 20px 40px rgba(30,42,57,0.08))' }}
                />
              </div>
            ...
            <div
              ...
              style={{
                backgroundImage: 'radial-gradient(circle, #1e2a39 1px, transparent 1px)',
